...
export const T: Dict = {
  ...
  co_briefing: { en: "Mission Briefing", uz: "Topshiriq Briefingi" },
  co_briefing_sub: {
    en: "Watch the briefing. Absorb the energy. Unlock the protocol.",
    uz: "Briefingni ko'r. Energiyani his qil. Protokolni ochib ber.",
  },
  ...
  co_loading: { en: "Channeling primordial energy...", uz: "Asl energiya yig'ilmoqda..." },
  co_forging: { en: "Forging...", uz: "Yaratilmoqda..." },
  co_empty_title: { en: "AWAITING SUMMON", uz: "CHAQIRIQ KUTILMOQDA" },
  co_empty_sub: { en: "Configure your archetype and forge the protocol. Aka, ready bo'l.", uz: "Arxetipingni sozla va protokolni yarat. Aka, tayyor bo'l." },
  co_err_title: { en: "Xatolik: Coach Offline.", uz: "Xatolik: Coach Offline." },
  co_err_sub: { en: "Aka, internetni tekshiring!", uz: "Aka, internetni tekshiring!" },
