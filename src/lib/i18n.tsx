...
Object.assign(T, {
  ...
  coach_chat_placeholder: { en: "Ask the coach…", uz: "Murabbiyga savol bering…", ru: "Задайте вопрос тренеру…" },
  coach_sign_in: { en: "Sign in", uz: "Kirish", ru: "Войти" },
  coach_building_plan: { en: "Building your training plan…", uz: "Mashg'ulot rejangiz tuzilmoqda…", ru: "Составляю ваш план тренировок…" },
  demo_title: { en: "Load sample data", uz: "Namuna ma'lumotlarini yuklash", ru: "Загрузить демо-данные" },
  demo_desc: { en: "Fill the dashboard with example plans, streaks and progress for presentations.", uz: "Namoyish uchun boshqaruv panelini namuna rejalar, seriyalar va natijalar bilan to'ldiradi.", ru: "Заполняет панель примерами планов, серий и прогресса для презентаций." },
  demo_on: { en: "Sample data on", uz: "Namuna ma'lumotlari yoniq", ru: "Демо-данные включены" },
  demo_off: { en: "Sample data off", uz: "Namuna ma'lumotlari o'chirilgan", ru: "Демо-данные выключены" },
  demo_badge: { en: "Sample data", uz: "Namuna ma'lumotlari", ru: "Демо-данные" },
  home_cta_title: { en: "No training plans yet", uz: "Hali mashg'ulot rejasi yo'q", ru: "Планов тренировок пока нет" },
  home_cta_desc: { en: "Your AI Coach will build a plan around your stats and training focus.", uz: "AI Murabbiy ma'lumotlaringiz va yo'nalishingizga mos reja tuzadi.", ru: "AI-тренер составит план по вашим данным и цели тренировок." },
