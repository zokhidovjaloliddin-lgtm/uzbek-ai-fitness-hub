...
export default function FloatingProBadge({
  ...
  return (
    <button
      ...
      className="group fixed bottom-20 left-5 z-[90] inline-flex items-center gap-2 rounded-full border-2 border-yellow-400 bg-gradient-to-br from-crimson to-primary-glow px-4 py-2.5 font-mono-tech text-[11px] font-bold uppercase tracking-widest text-white shadow-[0_0_24px_rgba(220,38,38,0.7)] transition hover:scale-105 hover:shadow-[0_0_36px_rgba(252,211,77,0.7)]"
    >
