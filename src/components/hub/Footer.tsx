import { Flame, GraduationCap, Code2, Mail } from "lucide-react";
    ...
    <div className="container mx-auto py-12">
      <div className="grid gap-8 md:grid-cols-3">
        ...
        <div>
          ...
          <div className="mt-3 inline-flex items-start gap-3 border-2 border-primary/60 p-4 shadow-crimson">
            ...
            <div>
              ...
              <a href="mailto:jaloliddinzokhidov@gmail.com" className="mt-2 inline-flex items-center gap-1.5 font-mono-tech text-xs text-crimson hover:text-primary-glow">
                <Mail className="h-3 w-3" /> jaloliddinzokhidov@gmail.com
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="mt-10 flex flex-col items-start justify-between gap-3 border-t border-border pt-6 font-mono-tech text-[10px] uppercase tracking-widest text-muted-foreground md:flex-row md:items-center">
        <div>© 2026 Absolute_Frame · Front-End Development Project | Jaloliddin Zoxidov (250040) | jaloliddinzokhidov@gmail.com</div>
